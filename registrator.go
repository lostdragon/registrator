...
var deregister = flag.String("deregister", "always", "Deregister exited services \"always\" or \"on-success\" or \"on-remove\"")
...
func main() {
	...
	if *deregister != "always" && *deregister != "on-success" && *deregister != "on-remove" {
		assert(errors.New("-deregister must be \"always\" or \"on-success\" or \"on-remove\""))
	}
